...
public final class ProtocoleChat
{
	 ...
	 */
	public static final char COMMANDE_QUITTE_CHAT = 'q';
	 ...
	 * </ul></p>
	 */
	public static final String MESSAGE_QUITTE_CHAT = "* Sortie du chat.";
	...
	public static final String MESSAGE_AIDE = "* Commandes disponibles : %n"
			...
			+ ProtocoleChat.ESPACE_MESSAGE_AIDE + ProtocoleChat.COMMANDE_CARACTERE
			+ ProtocoleChat.COMMANDE_QUITTE_CHAT + " : quitter le chat ;%n"
			;
