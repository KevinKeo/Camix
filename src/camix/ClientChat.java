...
public class ClientChat extends Thread 
{
	...
	/**
	 * boolean permettant de definir si nous continiuons avec le thread client ou si nous le fermons
	 */
	private boolean fin ;
		...
		if (ProtocoleChat.estUneCommande(message)) {
			...
			switch (ProtocoleChat.commandeDuMessage(message)) {
				...
				case ProtocoleChat.COMMANDE_AFFICHE_CLIENT : 
					...
					break;
				case ProtocoleChat.COMMANDE_QUITTE_CHAT : 
					this.chat.quitteChat(this);
					break;
				default : 
					this.chat.afficheInformationsClient(this);
					break;		
